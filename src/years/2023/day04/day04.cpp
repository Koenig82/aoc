...
Y2023d04::Y2023d04() {
    ...
    std::filesystem::path path("resources/Y2023d04/input.txt");
...
void Y2023d04::run2() {
    ...
    for (size_t extraTicketsindex = 0; extraTicketsindex < extraTickets.size(); extraTicketsindex++) {
        for (int i = 0; i < extraTickets[extraTicketsindex]; i++) {
            ...
            for (auto&& number : ticketObjects[extraTicketsindex].numbers) {
                if (std::find(ticketObjects[extraTicketsindex].winners.begin(),
                              ...
                              number) != ticketObjects[extraTicketsindex].winners.end()) {
                    extraTickets[cardindex + 1]++;
                    cardindex++;
                }
            }
